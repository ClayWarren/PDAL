...
| EPT reader | prototype | Local LASzip and uncompressed binary EPT full-file reads walk JSON hierarchy and merge local tiles. Zstandard EPT, spatial filtering, resolution limits, addons, remote access, and streaming are deferred. |
