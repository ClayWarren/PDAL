...
Current pre-port checkpoint: `774 / 903` baseline C++ GoogleTest cases, or
`85.71%`, are confirmed Rust C ABI-backed by
...
added during the port, is `813 / 953` currently built C++ GoogleTest cases, or
`85.31%`; compute that with `--include-added-tests`.
