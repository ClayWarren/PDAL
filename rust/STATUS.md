...
| category | LOC | files |
|---|---:|---:|
| port-candidate | 22,476 | 204 |
| c-abi-backed | 38,519 | 343 |
| native-adapter | 1,428 | 10 |
| holdout | 339 | 4 |
| total | 62,762 | 561 |

Port-candidate backlog by area: `pdal` 9,332 · `io` 8,010 · `filters` 3,436 ·
`kernels` 1,698. `apps` and `tools` are now at 0 (apps is a thin entry-point
...
`SplitKernel`/`TileKernel`/`TranslateKernel` execution through
