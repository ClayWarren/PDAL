...
| category | LOC | files |
|---|---:|---:|
| port-candidate | 13,645 | 142 |
| c-abi-backed | 41,776 | 368 |
| native-adapter | 2,921 | 23 |
| holdout | 1,279 | 5 |
| total | 59,621 | 538 |

Port-candidate backlog by area: `io` 7,466 · `pdal` 5,179 · `filters` 1,000. `kernels`, `apps` and `tools` are now at 0 (apps is a thin entry-point
