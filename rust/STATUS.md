...
- Metadata, pipeline, and command byte-shape parity: covered workflows route
  through Rust, but full C++ `PipelineWriter`, XML, full STAC projection
  metadata, and some stdout/stderr/artifact shapes remain scoped rather than
  globally done.
