...
Current pre-port checkpoint: `782 / 903` baseline C++ GoogleTest cases, or
`86.60%`, are confirmed Rust C ABI-backed by
...
added during the port, is `821 / 953` currently built C++ GoogleTest cases, or
`86.15%`; compute that with `--include-added-tests`.
