...
Current pre-port checkpoint: `779 / 903` baseline C++ GoogleTest cases, or
`86.27%`, are confirmed Rust C ABI-backed by
...
added during the port, is `818 / 953` currently built C++ GoogleTest cases, or
`85.83%`; compute that with `--include-added-tests`.
