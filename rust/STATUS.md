...
| category | LOC | files |
|---|---:|---:|
| port-candidate | 22,673 | 206 |
| c-abi-backed | 38,380 | 341 |
| native-adapter | 1,428 | 10 |
| holdout | 339 | 4 |
| total | 62,820 | 561 |

Port-candidate backlog by area: `pdal` 9,332 · `io` 8,010 · `filters` 3,436 ·
`kernels` 1,895. `apps` and `tools` are now at 0 (apps is a thin entry-point
...
`SplitKernel`/`TileKernel` execution through `pdal_rust_kernel_run`, reducing kernel
