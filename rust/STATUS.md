...
Current pre-port checkpoint: `775 / 903` baseline C++ GoogleTest cases, or
`85.83%`, are confirmed Rust C ABI-backed by
...
added during the port, is `814 / 953` currently built C++ GoogleTest cases, or
`85.41%`; compute that with `--include-added-tests`.
