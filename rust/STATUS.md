...
- EPT/COPC/STAC/remote breadth: transformed EPT preview point counts,
  semantically same-SRS and true cross-SRS transformed preview bounds
  clipping, and local origin/polygon/OGR preview point counts are Rust-pruned,
  but broad remote traversal, schema validation, object-store option parity,
  and accepted addon limitations remain.
