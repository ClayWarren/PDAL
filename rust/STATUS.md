...
- OGR/vector-source breadth: covered local vector reads/writes and tindex
  merge reads are Rust-backed, but broad OGR datasource/update workflows and
  similar native vector edge cases remain.
