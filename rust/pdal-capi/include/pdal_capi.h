...
bool pdal_point_view_mesh_triangle(const pdal_point_view_t* view, uint64_t idx, uint64_t* a, uint64_t* b, uint64_t* c);
bool pdal_point_view_add_mesh_triangle(pdal_point_view_t* view, uint64_t a, uint64_t b, uint64_t c);
