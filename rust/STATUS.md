...
| EPT reader | prototype | Local LASzip EPT full-file reads walk JSON hierarchy and merge local LAZ tiles. Binary/zstd EPT, spatial filtering, resolution limits, addons, remote access, and streaming are deferred. |
