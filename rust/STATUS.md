...
- EPT/COPC/STAC/remote breadth: covered EPT preview filters, local EPT/COPC/STAC
  workflows, and selected remote/VSI paths are Rust-backed, but broad remote
  traversal, schema validation, object-store option parity, and accepted addon
  limitations remain.
