...
- EPT/COPC/STAC preview and remote breadth: transformed EPT preview point
  counts plus local polygon/OGR preview point counts are Rust-pruned, but
  transformed preview bounds clipping, origin preview, broad remote traversal,
  schema validation, and object-store option parity remain named work items.
