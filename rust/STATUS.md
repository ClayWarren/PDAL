...
added during the port, is `790 / 932` currently built C++ GoogleTest cases, or
`84.76%`; compute that with `--include-added-tests`.
...
installed-app `sort`/`merge`/simple `tile`, `Utils::run_shell_command()`,
