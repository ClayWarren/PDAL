...
Current pre-port checkpoint: `786 / 903` baseline C++ GoogleTest cases, or
`87.04%`, are confirmed Rust C ABI-backed by
...
added during the port, is `825 / 953` currently built C++ GoogleTest cases, or
`86.57%`; compute that with `--include-added-tests`.
